...
// Resolve logo for PDF — Dompdf needs base64-embedded images
$tf_logo_path_s      = __DIR__ . '/../icons/logo.png';
$company_logo_path_s = (!empty($invoice['creator_logo']))
    ? __DIR__ . '/../' . $invoice['creator_logo']
    : null;

if (!function_exists('pdfLogoBase64')) {
...
$pdf_logo_b64    = ($company_logo_path_s && file_exists($company_logo_path_s))
    ...
    <table class="addr-table" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>
          ...
          <?php if (!empty($invoice['client_company'])): ?><?php echo htmlspecialchars($invoice['client_company']); ?><br><?php endif; ?>
