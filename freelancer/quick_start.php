...
// Fetch active projects — scoped to this company
$qs_stmt = $pdo->prepare("SELECT id, project_name FROM projects WHERE status = 'active' AND company_id = :company_id ORDER BY id DESC LIMIT 5");
